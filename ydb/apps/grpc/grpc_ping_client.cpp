...
// XXX
#include </home/eivanov89/repos/ydb/contrib/libs/grpc/src/core/lib/iomgr/port.h>
#include </home/eivanov89/repos/ydb/contrib/libs/grpc/src/core/lib/iomgr/executor.h>
#include </home/eivanov89/repos/ydb/contrib/libs/grpc/src/core/lib/event_engine/thread_pool.h>
...
using Ydb::Debug::PlainGrpcRequest;
using Ydb::Debug::PlainGrpcResponse;
...
void PrintUsage(const char* program_name) {
    ...
    std::cout << "  --print-grpc-flags   Print Linux-related gRPC compilation flags and exit" << std::endl;
}
...
BenchmarkRunResult RunBenchmark(const BenchmarkSettings& settings, int inflight) {
    ...
    for (int i = 0; i < max_channels; ++i) {
        ...
        channels.push_back(grpc::CreateCustomChannel(TString(target), grpc::InsecureChannelCredentials(), args));
    }
...
void PrintGrpcFlags() {
    auto prev = grpc_core::Executor::SetThreadsLimit(0);
    std::cout << "Executor thread limit: " << prev << std::endl;


    auto prevPool = grpc_event_engine::experimental::ThreadPool::SetThreadsLimit(0);
    std::cout << "Pool thread limit: " << prevPool << std::endl;

#ifdef NDEBUG
    std::cout << "NDEBUG: 1" << std::endl;
#else
    std::cout << "NDEBUG: 0" << std::endl;
#endif
